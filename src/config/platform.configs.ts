...
const MOMO_ACCESS_KEY = process.env.NODE_APP_MOMO_ACCESS_KEY ?? 'F8BBA842ECF85';
const MOMO_SECRET_KEY =
  process.env.NODE_APP_MOMO_SECRET_KEY ?? 'K951B6PE1waDMi640xX08PD3vg6EkVlz';

const FACEBOOK_APP_CLIENT_ID = process.env.NODE_APP_FACEBOOK_APP_CLIENT_ID;
const FACEBOOK_APP_REDIRECT_LOGIN =
  process.env.NODE_APP_FACEBOOK_APP_REDIRECT_LOGIN;
const FACEBOOK_APP_CLIENT_SECRET =
  process.env.NODE_APP_FACEBOOK_APP_CLIENT_SECRET;
const GOOGLE_APP_CLIENT_ID = process.env.NODE_APP_GOOGLE_APP_CLIENT_ID;
const GOOGLE_APP_REDIRECT_LOGIN =
  process.env.NODE_APP_GOOGLE_APP_REDIRECT_LOGIN;
const GOOGLE_APP_CLIENT_SECRET = process.env.NODE_APP_GOOGLE_APP_CLIENT_SECRET;
